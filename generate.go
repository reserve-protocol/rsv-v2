...
var targets = []target{
	target{Filename: "contracts/Reserve.sol", ContractName: "Reserve", SolcVersion: "0.5.8"},
	target{Filename: "contracts/ReserveV2.sol", ContractName: "ReserveV2", SolcVersion: "0.5.8"},
	target{Filename: "contracts/ReserveEternalStorage.sol", ContractName: "ReserveEternalStorage", SolcVersion: "0.5.8"},
	target{Filename: "contracts/Basket.sol", ContractName: "Basket", SolcVersion: "0.5.8"},
	target{Filename: "contracts/Manager.sol", ContractName: "Manager", SolcVersion: "0.5.8"},
	target{Filename: "contracts/Proposal.sol", ContractName: "Proposal", SolcVersion: "0.5.8"},
	target{Filename: "contracts/Vault.sol", ContractName: "Vault", SolcVersion: "0.5.8"},
	target{Filename: "contracts/Ownable.sol", ContractName: "Ownable", SolcVersion: "0.5.8"},
}
